function [Tends, Rpeaks, asum] = twaveend_original_tdom(s0, fs,RRk)
...
%     round(0.01*fc) = Rpeaks(knR+1)- kR;
%   else
%     round(0.01*fc) = 200*fratio;
%   end
